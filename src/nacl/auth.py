...
AUTH_SIZE = nacl.c.crypto_auth_BYTES
KEY_SIZE = nacl.c.crypto_auth_KEYBYTES
...
def generate(message, key, encoder=nacl.encoding.RawEncoder):
    ...
    authenticator = nacl.c.crypto_auth(message, key)
...
def verify(authenticator, message, key, encoder=nacl.encoding.RawEncoder):
    ...
    return nacl.c.crypto_auth_verify(authenticator, message, key)
